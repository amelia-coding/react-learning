  ...
  switch (finishedWork.tag) {
    ...
    case ClassComponent: {
      ...
      if (finishedWork.effectTag & Update) {
        // 这个current 是 workInProgress Fiber,也就是上一次渲染的fiber的镜像
        // 为null，说明是第一次渲染
        if (current === null) {
...
// 已经是在处理真实的dom了，在这个过程当中，已经是不可打断的，
// 把所有的副作用，根据不同的EffectTag,处理dom的更新逻辑
